...
const translations = {
  ar: {
    ...
    "hero.lead": "مهندس كهرباء وتحكم متخصص في أنظمة القدرة والتحكم، الأتمتة، الصيانة الكهربائية، الإشراف الفني، وحل المشكلات في البيئات الصناعية والطبية والبترولية، وجاهز للعمل في مكة وجدة والمدينة.",
  ...
  en: {
    ...
    "hero.lead": "Power & Control Engineer specializing in power systems, control and automation, electrical maintenance, technical supervision, and problem-solving across industrial, medical, and petroleum environments, available for opportunities in Makkah, Jeddah, and Madinah.",
